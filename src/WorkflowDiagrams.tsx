...
const WorkflowNode: React.FC<{
  ...
  const { x, y, w, h, shape = "rounded", color, label, icon, fill } = node;
...
// ═══════════════════════════════════════════════════════════════════════════════
const PRICE_INTEGRITY_CONFIG: WorkflowConfig = {
...
// ═══════════════════════════════════════════════════════════════════════════════
const PROOF_OF_RESERVE_CONFIG: WorkflowConfig = {
...
// ═══════════════════════════════════════════════════════════════════════════════
const REGIME_MODEL_CONFIG: WorkflowConfig = {
...
// ═══════════════════════════════════════════════════════════════════════════════
const SETTLEMENT_CONFIG: WorkflowConfig = {
